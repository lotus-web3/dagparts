...
var _ blockstore.BasicBlockstore = (*IPFSBlockstore)(nil)

func NewLocalIPFSBlockstore(ctx context.Context, onlineMode bool) (blockstore.Blockstore, error) {
	...
	return blockstore.Adapt(bs), nil
}

func NewRemoteIPFSBlockstore(ctx context.Context, maddr multiaddr.Multiaddr, onlineMode bool) (blockstore.BasicBlockstore, error) {
